...
class KbReasonLog extends ObjectModel
{
    ...
    private $reason_types = array(
        1 => array('key' => 'seller_dissapproved', 'label' => 'Seller Account Dissapproved'),
        2 => array('key' => 'product_del_by_sellet', 'label' => 'Product Deletion by Seller'),
        3 => array('key' => 'product_dissaproved_by_admin', 'label' => 'Product Dissapproved by Admin'),
        4 => array('key' => 'review_dissaproved_by_admin', 'label' => 'Review Dissapproved by Admin'),
        5 => array('key' => 'category_dissaproved_by_admin', 'label' => 'Category Dissapproved by Admin')
    );
